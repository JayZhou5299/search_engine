...
def get_json():
    headers = {"Accept": "application/json",
               ...
               "Referer": "https://ke.qq.com/course/131889",
               "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36"
               }
    try:
        res = requests.get("https://ke.qq.com/cgi-bin/get_course_latest_liveTask?course_id=131889&bkn=&r=0.4623820062445074", headers=headers)
        print(res.text)
